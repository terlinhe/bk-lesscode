...
import { getTenantIdHeader } from '../service/open-api'
    ...
    async createAndExecuteTask(
        ...
        const bkFlowTaskDetail = await execApiGateWay({
            ...
            data: {
                ...
                scope_type: 'app_env',
                scope_value: apiGateWayConfig.stageName
            },
        ...
        if (bkFlowTaskDetail.result) {
            const taskData = await dataService.add(
                'flow-task',
                {
                    ...
                    name: taskName,
                    nodes: JSON.stringify(flowDetail.nodes),
                    edges: JSON.stringify(flowDetail.edges)
                }
            )
